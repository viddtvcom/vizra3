<h2 class="title700">##Nav%YourCart## <a href="{$vurl}?p=cart&s=do&a=empty" class="right">##EmptyCart##</a></h2>
    ...
    {if $cart->domains}
        <table cellpadding="0" cellspacing="0" class="main_table">
            ...
            {foreach from=$cart->domains item=d key=domain}
                <tr>
                    <td valign="middle" width="30">
                        <a href="{$vurl}?p=cart&s=domconf&a=rm&d={$domain}"><img src="images/ico_delete.png" width="16"
                                                                                 height="16"/></a>
                    </td>
                    <td>
                        {$domain}

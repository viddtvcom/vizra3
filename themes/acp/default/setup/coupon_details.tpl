        ...
        <fieldset>
            <ol>
                ...
                <li>
                    ...
                    <!--                <select name="type">
                    <option value="percentage" {if $CPN->type == 'percentage' }selected{/if}>Yüzde indirim</option>
                    <option value="fixed" {if $CPN->type == 'fixed' }selected{/if}>##Inactive##</option>
                </select>-->
                </li>
                <li>
                    ...
                    <select name="services[]" multiple="multiple">
                        {foreach from=$services item=srv}
                            <option value="{$srv.serviceID}"
                                    {if in_array($srv.serviceID,$CPN->services)}selected{/if}>{$srv.service_name}</option>
                        {/foreach}
                    </select>
                </li>
            </ol>

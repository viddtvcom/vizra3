...
<div class="row">
    ...
    <div class="inputs">
           <span class="input_wrapper select_wrapper">
           <select name="groupID" id="type" class="text">
               <option value="1" {if $client->groupID == '1'}selected{/if}>Genel Müşteriler</option>
               <option value="3" {if $client->groupID == '3'}selected{/if}>%10 indirimli</option>
               <option value="4" {if $client->groupID == '4'}selected{/if}>%20 indirimli</option>
               <option value="5" {if $client->groupID == '5'}selected{/if}>%25 indirimli</option>
           </select>
           </span>
    </div>
</div>

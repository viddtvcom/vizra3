    ...
    <div id="filterbox">
        <form method="post" class="cmxform" id="filterform">
            <fieldset style="width: 40%; float: left;">
                <ol class='alt'>
                    <li><label>Müşteri No:</label> <input type="text" name="clientID" class="filter"
                                                          style="width: 80px;" maxlength="7"></li>
                    <li><label>İsim / Email</label> <input type="text" name="name_email" class="filter"
                                                           style="width: 150px;" value="{$smarty.get.name_email}"></li>
                </ol>
            </fieldset>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    {foreach from=$clients item=c}
                        <tr class="{cycle values="first,second"}">
                            ...
                            <td><a href="?p=310&act=delClient&clientID={$c.clientID}"

...
function doParentIframe() {
    if ($('#mainframe', parent.document).length > 0) {
        var newHeight = $('#mainframe', parent.document)[0].contentWindow.document.body.offsetHeight;
        $('#mainframe', parent.document).css('height', newHeight + 'px');
        //var mainFrame = parent.document.getElementById('mainframe');
        //mainFrame.style.height = mainFrame.contentWindow.document.body.offsetHeight + 'px';
    }
}
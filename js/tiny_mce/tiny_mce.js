(function (d) {
    ...
    var b = {majorVersion: "3", minorVersion: "3.9.3", releaseDate: "2010-12-20", _init: function () {
...
(function (m) {
    ...
    m.create("tinymce.dom.DOMUtils", {doc: null, root: null, files: null, pixelStyles: /^(top|left|bottom|right|width|height|borderWidth)$/, props: {"for": "htmlFor", "class": "className", className: "className", checked: "checked", disabled: "disabled", maxlength: "maxLength", readonly: "readOnly", selected: "selected", value: "value", id: "id", name: "name", type: "type"}, DOMUtils: function (u, q) {
        var p = this, o;
        p.doc = u;
        p.win = window;
        p.files = {};
...
(function (c) {
    var d = /[&\"<>]/g, b = /[<>&]/g, a = {"&": "&amp;", '"': "&quot;", "<": "&lt;", ">": "&gt;"};
    c.create("tinymce.dom.StringWriter", {str: null, tags: null, count: 0, settings: null, indent: null, StringWriter: function (e) {
        this.settings = c.extend({indent_char: " ", indentation: 0}, e);
        this.reset()
    }, reset: function () {
        this.indent = "";
        this.str = "";
...
(function (m) {
    ...
    m.create("tinymce.Editor", {Editor: function (r, q) {
        ...
        z.formatter.register({alignleft: [
        ...
        var z = this, r, A = z.settings, q = z.dom, x = {mouseup: "onMouseUp", mousedown: "onMouseDown", click: "onClick", keyup: "onKeyUp", keydown: "onKeyDown", keypress: "onKeyPress", submit: "onSubmit", reset: "onReset", contextmenu: "onContextMenu", dblclick: "onDblClick", paste: "onPaste"};
        ...
        z.onReset.add(function () {
            z.setContent(z.startContent, {format: "raw"})
        });
        ...
        if (m.isIE) {
            q.bind(z.getDoc(), "controlselect", function (B) {
                ...
                t = z.resizeInfo = {node: B, ev: ev, cb: s}
            });
            z.onKeyDown.add(function (s, t) {
                switch (t.keyCode) {
                    case 8:
...
(function (b) {
    ...
    b.UndoManager = function (e) {
        ...
        return c = {typing: 0, onAdd: new a(c), onUndo: new a(c), onRedo: new a(c), add: function (l) {
...
(function (m) {
    ...
    m.create("tinymce.ForceBlocks", {ForceBlocks: function (o) {
...
(function (a) {
    function b() {
        ...
        a.extend(this, {add: function (i, h, g) {
            f(d, i, h, g)
...
(function (a) {
    a.Formatter = function (T) {
        var K = {}, M = a.each, c = T.dom, p = T.selection, s = a.dom.TreeWalker, I = new a.dom.RangeUtils(c), d = T.schema.isValid, E = c.isBlock, k = T.settings.forced_root_block, r = c.nodeIndex, D = "\uFEFF", e = /^(src|href|style)$/, Q = false, A = true, o, N = {apply: [], remove: []};
        ...
        function z(W, af, Z) {
            ...
            function ai(aj) {
                ...
                if (ah.split) {
                    ...
                    al = H(aj);
                    if (ak != al) {
                        ak = L(ak, "span", {id: "_start", _mce_type: "bookmark"});
                        al = L(al, "span", {id: "_end", _mce_type: "bookmark"});
                        ag(ak);
                        ag(al);
                        ak = ac(A);
                        al = ac()
